module.exports = {
    ...
    "globals": {
        ...
        "requestAsync": false,
        "redisAsync": false,
        "_tc_bridge_util": false,
        "_tc_bridge_bar": false,
        "_tc_bridge_public": false
    },
    "rules": {
        ...
        "require-await": 2, //禁止不包含 await 的 async 函数
        ...
        "no-unused-vars": [2, { "varsIgnorePattern": "app" }], //
        "no-use-before-define": [1, { "functions": false, "classes": false }], //禁止在变量定义之前使用它们
        ...
        "id-length": [0, { "min": 2 }, ], //强制标识符的最大和最小长度
        ...
        "max-depth": [1, { "max": 10 }], //强制可嵌套的块的最大深度
        "max-len": [0], //强制一行的最大长度
